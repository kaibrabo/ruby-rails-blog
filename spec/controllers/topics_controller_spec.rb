...
RSpec.describe TopicsController, type: :controller do
    ...
    context "member user" do
        before do
            user = User.create!(name: "testUser", email: "user@test.com", password: "helloworld", role: :member)
            create_session(user)
        end
    ...
    context "moderator user" do
        before do
            user = User.create!(name: "testUser", email: "user@test.com", password: "helloworld", role: :moderator)
            create_session(user)
        end
    ...
    context "admin user" do
        before do
            user = User.create!(name: "testUser", email: "user@test.com", password: "helloworld", role: :admin)
            create_session(user)
        end
